 ...
 * @version 
 * @date 2020年6月18日下午2:05:20
 *
 *	1. static：静态的
 *	2. static可以用来修饰：属性， 方法，代码块， 内部类
 *
 *	3. 使用static修饰属性: 称为 静态变量(或类变量)
 ...
 *			对象		yes		yes
 *			③ 静态方法中， 只能调用静态的方法或属性
 *				非静态方法中， 既可以调用非静态方法的方法或属性， 也可以调用静态的方法或属性
 *
 *	5. static注意点：
 ...
 *
 *	实例变量：当我们new， 创建某个对象的时候， 
 *		我们才在堆空间中为这个对象开辟空间， 然后生成该对象的 属性， 也就是随着对象的创建而加载的
 *
 *	静态变量：静态变量随着类的记载而加载
 */
